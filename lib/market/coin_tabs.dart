            ...
            actions: <Widget>[
              InkWell(
                ...
                child: Container(
                    ...
                    child: Image(
                      image:
                      AssetImage("assets/Group27.png"),fit: BoxFit.fill,)),
              ),
              widget.enableTransactions ? Container() : new Container(),
            ],
          ),
        ),
        body: new TabBarView(
                        ...
                        children: <Widget>[
                          Row(
                            ...
                            children: [
                              Padding(
                                padding:
                                    const EdgeInsets.only(left: 4, bottom: 0,right: 10),
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    ...
                                    letterSpacing: -0.1,
                                    color:
                                        FitnessAppTheme.grey.withOpacity(0.8),
                                  ),
                                ),
                              ),
                      ...
                      children: [
                        ...
                        Text(
                            num.parse(holdings.toStringAsPrecision(9))
                                ...
                                symbol,
                            style: Theme.of(context).textTheme.body2.apply(
                                fontSizeFactor: 1.5, color: Colors.grey[800])),
                        SizedBox(
                          height: MediaQuery.of(context).size.height * 0.01,
                        ),
                        new Text("Total Cost",
